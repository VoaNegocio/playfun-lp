...
const FinalCTA = () => {
    return (
        <section className="w-full py-24 bg-brand-peach/20 px-4">
            <div className="container mx-auto max-w-4xl text-center flex flex-col items-center gap-8">
                ...
                <div className="pt-6">
                    <a
                        ...
                        className="inline-flex items-center gap-3 bg-brand-peach text-white px-10 py-5 rounded-full shadow-lg hover:shadow-xl hover:bg-orange-300 transition-all duration-300 transform hover:-translate-y-1 font-sans text-xl font-medium tracking-wide"
                    >
